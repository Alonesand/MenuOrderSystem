...
public class FrmLogin extends JDialog implements ActionListener {
	...
	private JLabel sexLabel = new JLabel("类型:");
	private JRadioButton userType = new JRadioButton("用户");
	private JRadioButton GodType = new JRadioButton("管理员");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.btnLogin) {
			...
			FrmUserManager_AddUser dlg=new FrmUserManager_AddUser(this,"注册账号",true);
			dlg.setVisible(true);
